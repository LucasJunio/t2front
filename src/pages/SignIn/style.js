...
#formContent {
  ...
  text-align: center;
  font-family: "nexa Light", montserrat;
}
...
* {
  ...
  @media tv and (max-width: 1024px) and (orientation: landscape) {
  ...
  @media (max-width: 600px){  
    ...
    /*Apenas os article pares*/
   #singin article:nth-child(even){
        margin-left: 20px;
    }
